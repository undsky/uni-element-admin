<template>
	<view class="signature-wrap">
		<canvas v-if="isMobile" :canvas-id="cid" :id="cid" @touchstart="onTouchStart" @touchmove="onTouchMove"
		...
		<canvas v-else :canvas-id="cid" :id="cid" @mousedown="onMousedown" @mousemove="onMousemove" @mouseup="onMouseup"
			@mouseleave="onMouseleave" disable-scroll :style="[
					{
						width: width && formatSize(width),
						height: height && formatSize(height)
					},
