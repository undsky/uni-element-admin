<template>
	<view id="top-window" class="top-window flex">
		<view v-if="!isXS" class="nav-header flex flex-justify-center flex-align-center" :style="{
        minWidth: (isCollapse ? 64 : 230) + 'px',
		...
		<view class="flex flex-align-end">
			<el-tabs v-contextmenu:contextmenu :style="{
          width:
            'calc(100vw - ' +
            (isXS
              ? 80
              : isCollapse
              ? 64 + 40 + userPanelWidth
              : 230 + 40 + userPanelWidth) +
            'px)',
		...
		<view class="nav-right flex flex-align-center"
			...
			<template v-if="!isXS">
				<mc-message @message="
            navigateTo('message', '/pages/system/message/message', true)
          "></mc-message>
			...
			<el-dropdown trigger="click" @command="userCommand">
				...
				<el-dropdown-menu slot="dropdown">
					<el-dropdown-item icon="el-icon-house" command="self">{{
            i18n.self
          }}</el-dropdown-item>
					<template v-if="isXS">
					...
					<el-dropdown-item icon="el-icon-back" command="logout" divided>{{
            i18n.logout
          }}</el-dropdown-item>
				</el-dropdown-menu>
			</el-dropdown>
