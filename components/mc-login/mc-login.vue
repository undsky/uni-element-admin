<template>
	<view>
		...
		<view v-show="'qrcode' != activeTab" class="flex">
			<el-button class="flex1" :type="theme" @click="login">{{
        i18n.login
      }}</el-button>
		</view>
		<view class="footer flex flex-column flex-justify-center padding-bottom">
			<el-link href="https://www.undsky.com/" :underline="false" target="_blank">© 2019-2024 undsky MIT license
			</el-link>
