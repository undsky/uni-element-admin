	...
	<scroll-view class="main" scroll-y>
		...
		<view class="padding">
			...
			<drag-verify ref="dragVerify" :isPassing.sync="dragVerifyPassing" text="请按住滑块拖动" successText="验证通过"
				handlerIcon="el-icon-d-arrow-right" successIcon="el-icon-circle-check" @passcallback="pass">
			</drag-verify>
		</view>
		<view class="padding">
		...
		<view class="padding">
			...
			<drag-verify-img-chip ref="dragVerify" :imgsrc="imgChip" :isPassing.sync="dragVerifyImgChipPassing"
				:showRefresh="true" text="请按住滑块拖动" successText="验证通过" handlerIcon="el-icon-d-arrow-right"
		...
		<view class="padding">
			...
			<vaptcha-v3 v-if="isShowVaptcha" :vid="vid" :scene="0" :lang="lang" :area="area"
	...
	export default {
		...
		data() {
			return {
				...
				imgChip: 'https://beehives.imfdj.top/static/img/dragChipImgs/5.jpg',
				imgRotate: 'https://yimijianfang.github.io/vue-drag-verify/static/img/111.22e0821.jpg',
