<template>
	<scroll-view class="main" scroll-y>
		<view class="padding">
			...
			<drag-verify ref="dragVerify" :isPassing.sync="dragVerifyPassing" text="请按住滑块拖动" successText="验证通过"
				handlerIcon="el-icon-d-arrow-right" successIcon="el-icon-circle-check"
				@passcallback="pass"></drag-verify>
		</view>
		<view class="padding">
			<el-divider content-position="left">图片验证码</el-divider>
			<drag-verify-img ref="dragVerify" :imgsrc="img" :isPassing.sync="dragVerifyImgPassing" :showRefresh="true"
				text="请按住滑块拖动" successText="验证通过" handlerIcon="el-icon-d-arrow-right" successIcon="el-icon-circle-check"
				@refresh="reimg" @passcallback="pass"></drag-verify-img>
		</view>
		<view class="padding">
			<el-divider content-position="left">拼图验证码</el-divider>
			<mc-verify-img-chip ref="verifyImgChip" @passcallback="verifyImgChipPasscallback"
				@passfail="verifyImgChipPassFail"></mc-verify-img-chip>
		...
		<view class="padding">
			...
			<drag-verify-img-rotate ref="dragVerify" :imgsrc="imgRotate" :isPassing.sync="dragVerifyImgRotatePassing"
				:showTips="true" text="请按住滑块拖动" successText="验证通过" handlerIcon="el-icon-d-arrow-right"
				successIcon="el-icon-circle-check" @refresh="reimg" @passcallback="pass"></drag-verify-img-rotate>
		</view>
		<view class="padding">
			<el-divider content-position="left">手势验证码</el-divider>
			<button @click="showVaptcha()">打开手势验证</button>
			<vaptcha-v3 v-if="isShowVaptcha" :vid="vid" :scene="scene" :lang="lang" :area="area" :url="url"
				v-on:receive="handleMessage"></vaptcha-v3>
		</view>
	</scroll-view>
</template>
...
<script>
	...
	import captcha1 from '@/static/demo/captcha1.jpg'
	import captcha2 from '@/static/demo/captcha2.jpg'
	import captcha3 from '@/static/demo/captcha3.jpg'
